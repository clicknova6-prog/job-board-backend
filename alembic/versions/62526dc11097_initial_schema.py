...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "records_staged", sa.Integer(), server_default=sa.text("0"), nullable=False
        ),
        sa.Column(
            "records_imported",
            sa.Integer(),
        ...
        sa.CheckConstraint(
            "records_received >= 0 AND records_staged >= 0 AND records_imported >= 0 AND records_rejected >= 0",
    ...
    op.create_index(
        "import_runs_status_created_at_idx",
        "import_runs",
    ...
    op.create_index(
        "job_staging_import_run_valid_idx",
        "job_staging",
        ["import_run_id", "is_valid"],
        unique=False,
    )
    op.create_table(
        "jobs",
        ...
        sa.ForeignKeyConstraint(
            ["last_seen_import_run_id"], ["import_runs.id"], ondelete="RESTRICT"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
    ...
    op.create_index(
        "jobs_last_seen_import_run_id_idx",
        "jobs",
